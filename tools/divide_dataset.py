...
def parge_config():
    ...
    parser.add_argument(
        '--root_path',
        type=str,
        default='/home1/yinhaoli/data/gastric_mucosa/first_batch',
...
class DivideDataset():
    ...
    def divide(self):
        ...
        for name in train_names:
            ...
            shutil.copyfile(
                os.path.join(self.root_path, 'annotations', name),
                os.path.join(self.target_path, 'train', 'annotations', name))
        for name in valid_names:
            ...
            shutil.copyfile(
                os.path.join(self.root_path, 'annotations', name),
                os.path.join(self.target_path, 'valid', 'annotations', name))
        for name in test_names:
            ...
            shutil.copyfile(
                os.path.join(self.root_path, 'annotations', name),
                os.path.join(self.target_path, 'test', 'annotations', name))
